...
// .wrangler/tmp/pages-Es0RSR/functionsWorker-0.9391267277353269.mjs
...
var onRequest = /* @__PURE__ */ __name2(async (context) => {
  ...
  if (!rooms.has(roomName)) {
    rooms.set(roomName, /* @__PURE__ */ new Set());
  }
...
async function persistToUpstash(env, roomName, data) {
  if (!env.UPSTASH_REDIS_REST_URL || !env.UPSTASH_REDIS_REST_TOKEN) {
    return;
  }
  try {
    const key = `quartier:room:${roomName}:updates`;
    const value = typeof data === "string" ? data : Buffer.from(data).toString("base64");
...
__name(persistToUpstash, "persistToUpstash");
__name2(persistToUpstash, "persistToUpstash");
var routes = [
  {
...
// ../../.bun/install/global/node_modules/wrangler/templates/pages-dev-util.ts
...
// .wrangler/tmp/pages-Es0RSR/eq00yntg5gt.js
...
// .wrangler/tmp/bundle-x9Wum9/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-x9Wum9/middleware-loader.entry.ts
